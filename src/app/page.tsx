...
export default function Home() {
  return (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Products Card */}
              <div className="border p-4 rounded-lg shadow hover:shadow-lg transition-all bg-white" >
                ...
                <p className="text-gray-500 text-sm mt-2">$150.00</p>
                <button className="bg-blue-500 text-white py-2 px-4 rounded mt-4">Add to card</button>
              </div>
              <div className="border p-4 rounded-lg shadow hover:shadow-lg transition-all bg-white" >
    ...
    <div className="px-2 md:px-4 lg:px-8 ml-2">
      {/* Discount Section */}
      <section className="my-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Left Side */}
          <div className="w-[500px] p-6 bg-pink-100 rounded-lg shadow -ml-10">
            <h3 className="w-[269px] h-[26px] text-2xl  mt-6 text-[#151875] font-josefin font-[600] size-[26px] leading-[26px] text-center">23% off on all products</h3>
            <p className="w-[74px] h-[19px] text-pink-500  mt-2 font-lato font-[600] leading-[19.2px] text-center">Shop Now</p>
            <div className="mt-4 relative ml-40">
              <Image src="/clock.png" alt="Discount Product" width={300} height={200} />
            </div>
          </div>

          {/* Right Side */}
          <div className="w-[700px] grid grid-cols-1 md:grid-cols-2 gap-6 absolute right-10">
            ...
            <div className="rounded-lg shadow flex">
              <div className="w-[700px] grid grid-row-1 md:grid-rows-2 gap-6">
              ...
              <p className="w-[37px] h-[12px] font-josefin font-[400] size-3 leading-3 items-center text-[#151875] mt-4">$32.00</p>
              <Image src="/Line 2.png" alt="" width={58} height={10} className="text-[#EEEFFB]"/>
              </div>
               <div className="mt-4">
                <p className="w-[200px] h-[16px] font-josefin size-4 leading-[18.75px] items-center text-[#151875] text-xl ">Executive Seat chair</p>
              <p className="w-[37px] h-[12px] font-josefin font-[400] size-3 leading-3 items-center text-[#151875] mt-4">$32.00</p>
